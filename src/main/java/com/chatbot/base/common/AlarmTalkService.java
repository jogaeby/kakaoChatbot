...
public class AlarmTalkService {
    ...
    public void sendTrialBefore(String phone, String studentName, LocalDateTime date) {
        ...
        KakaoOption kakaoOption = new KakaoOption();
        kakaoOption.setPfId(CHANNEL_ID);
        kakaoOption.setTemplateId(TRIAL_BEFORE_TEMPLATE_ID);
        kakaoOption.setDisableSms(true);
    ...
    public void sendTrialAfter(String phone, String studentName, LocalDate date) {
        ...
        KakaoOption kakaoOption = new KakaoOption();
        kakaoOption.setPfId(CHANNEL_ID);
        kakaoOption.setTemplateId(TRIAL_AFTER_TEMPLATE_ID);
        kakaoOption.setDisableSms(true);
    ...
    public MultipleDetailMessageSentResponse sendInterviewReceipt(String phone, String zoomUrl, LocalDateTime date) {
        DefaultMessageService messageService =  NurigoApp.INSTANCE.initialize(API_KEY, API_SECRET_KEY, "https://api.solapi.com");

        KakaoOption kakaoOption = new KakaoOption();
        kakaoOption.setPfId(CHANNEL_ID);
        kakaoOption.setTemplateId(INTERVIEW_RECEIPT_TEMPLATE_ID);
        kakaoOption.setDisableSms(true);
    ...
    public void sendInterviewBefore(String teacherName, String phone, String zoomUrl, LocalDateTime date) {
        ...
        KakaoOption kakaoOption = new KakaoOption();
        kakaoOption.setPfId(CHANNEL_ID);
        kakaoOption.setTemplateId(INTERVIEW_BEFORE_TEMPLATE_ID);
        kakaoOption.setDisableSms(true);
    ...
    @Async
    public void sendInterviewAfter(String phone, String teacherName) {
        DefaultMessageService messageService =  NurigoApp.INSTANCE.initialize(API_KEY, API_SECRET_KEY, "https://api.solapi.com");

        KakaoOption kakaoOption = new KakaoOption();
        kakaoOption.setPfId(CHANNEL_ID);
        kakaoOption.setTemplateId(INTERVIEW_AFTER_TEMPLATE_ID);
        kakaoOption.setDisableSms(true);

        HashMap<String, String> variables = new HashMap<>();
        variables.put("#{선생님명}", teacherName);
